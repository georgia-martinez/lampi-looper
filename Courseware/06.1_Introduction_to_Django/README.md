...
1. [Writing your first Django app](https://docs.djangoproject.com/en/5.0/intro/tutorial01/)
    ...
    * [Install Django](https://docs.djangoproject.com/en/5.0/intro/install/) on EC2 with [pip3](https://docs.djangoproject.com/en/5.0/topics/install/#installing-an-official-release-with-pip)

    ```
    sudo pip3 install django==5.0.1
    ```
